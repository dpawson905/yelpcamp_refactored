  ...
  async postRegister(req, res, next) {
    ...
    */
    ...
    try {
      ...
      req.flash(
        "success",
        "Thanks for registering. Please check you email to verify your account."
      );
      return res.redirect("/");
    } catch (err) {
      if (err) return next(err);
      req.flash(
        "Something went wrong please contact us so we can look into it."
      );
      return res.redirect("back");
    }
  },
